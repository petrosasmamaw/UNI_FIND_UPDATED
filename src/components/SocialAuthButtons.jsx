    ...
    <div className="w-full">
      ...
      <div className="flex w-full gap-3">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-3 py-2 rounded-lg bg-transparent border border-white/20 text-white text-sm font-semibold hover:bg-white/5 transition"
        >
